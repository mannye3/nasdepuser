                            ...
                            <div class="kyc-app wide-sm m-auto">
                                <div class="nk-block-head nk-block-head-lg wide-xs mx-auto">
                                    <div class="nk-block-head-content text-center">
                                        <h2 class="nk-block-title fw-normal">Add Enterprise</h2>
                                        <div class="nk-block-des">
                                            <p> This is the business listing form designated for entrepreneurs and business managers. </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="nk-kycfm">
                                                ...
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" value="{{ Auth::User()->email}}" class="form-control form-control-lg">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" value="{{ Auth::User()->phone}}" class="form-control form-control-lg">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="form-label-group">
                                                              <label class="form-label" for="fw-last-name">Designation</label>
                                                            </div>
                                                            <div class="form-control-group">

                                                                    <div class="form-control-wrap">
                                                                           <input type="text" value="{{ Auth::User()->designation}}" class="form-control form-control-lg">
                                                                    </div>
                                                                </div>
                                                        </div>
                                                    </div><!-- .col -->
                                            ...
                                            <div class="nk-kycfm-head">
                                                ...
                                                <div class="nk-kycfm-title">
                                                    ...
                                                    <p class="sub-title">Please type carefully and fill out the form with your personal details. Your can’t edit these details once you submitted the form.</p>
                                                </div>
                                            </div><!-- .nk-kycfm-head -->
                                            <div class="nk-kycfm-content">
                                                <div class="nk-kycfm-note">
                                                ...
                                                <div class="row g-4">
                                                              ...
                                                              <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control-wrap">
                                                                        <input value="{{ Auth::User()->company}}"  type="text" data-msg="" class="form-control " id="fw-first-name" name="name" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="fw-last-name">REG NUM</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" data-msg="" class="form-control " id="fw-last-name" name="number" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="fw-nationality">State</label>
                                                                    <div class="form-control-wrap ">
                                                                        <div class="form-control-select">
                                                                            <select class="form-control" data-msg=""  name="state_id" >
                                                                                  <option>--State--</option>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="fw-email-address">Years of operation</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" data-msg="" data-msg-email="Wrong Email" class="form-control"  name="exp" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="fw-mobile-number">Industry</label>
                                                                    <div class="form-control-wrap">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="fw-password">Growth Stage</label>
                                                                    <div class="form-control-wrap">
                                                                       <select class="form-control " data-msg="" id="fw-nationality" name="growth_stage" >
                                                                                <option value="">Select Stage</option>
                                                                                <option value="Initial Growth">Initial Growth</option>
                                                                                <option value="Early Expansion">Early Expansion</option>
                                                                                <option value="Late Expansion">Late Expansion</option>
                                                                                <option value="Distresse">Distresse</option>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="fw-password">Type of investor</label>
                                                                    <div class="form-control-wrap">
                                                                         <select class="form-control " data-msg="" id="fw-nationality" name="toi" >
                                                                                <option value="">Select Stage</option>
                                                                                <option value="Strategic Partner/Investor">Strategic Partner/Investor</option>
                                                             ...
                                                             <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="fw-password">Type of funding Required</label>
                                                                    <div class="form-control-wrap">
                                                                        <select class="form-control " data-msg="" id="fw-nationality" name="tof" >
                                                                                <option value="">Select Stage</option>
                                                             ...
                                                             <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="fw-password">Years of last audited financials</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" data-msg="" class="form-control " id="" name="ylaf" >
                                                                    </div>
                                                                </div>
                                                            </div><!-- .col -->
                                                             ...
                                                             <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="fw-password">Turnover(Annual)in that year</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" data-msg="" class="form-control " id="" name="ylaf_turnover" >
                                                                    </div>
                                                                </div>
                                                            </div><!-- .col -->
                                                             ...
                                                             <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="fw-password">Amount to be raised</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" data-msg="" class="form-control " id="" name="amount" >
                                                                    </div>
                                                                </div>
                                                            </div><!-- .col -->
                                            ...
                                            <div class="nk-kycfm-content">
                                                ...
                                                <h6 class="title">To avoid delays when verifying Enterprise, Please make sure bellow:</h6>
                                                ...
                                                <div class="nk-kycfm-upload">
                                                    <h6 class="title nk-kycfm-upload-title">Upload Supporting Document</h6>
                                                    <div class="row align-items-center">
                                                        <div class="col-sm-6">
                                                            <div class="nk-kycfm-upload-box">
                                                                <div class="">
                                                                      <input name="doc" type="file" class="dropify" data-height="100" />
                                                  ...
                                                  <div class="nk-kycfm-upload">
                                                    <h6 class="title nk-kycfm-upload-title">Upload Company Logo</h6>
                                                    <div class="row align-items-center">
                                                        <div class="col-sm-6">
                                                            <div class="nk-kycfm-upload-box">
                                                                <div class="">
                                             ...
                                             <div class="form-group">
                                                <div class="col-md-12">
                                                                ...
                                                                <textarea name="profile" class="summernote-basic"></textarea>
                                                </div>
                                                            </div>
