                        ...
                        <div class="nk-content-body">
                            <div class="kyc-app wide-sm m-auto">
                               ...
                               @endif --}}
                                         ...
                                         <form  method="POST" action=" {{ route('submitDDAKYC')}}" enctype="multipart/form-data">
                                @csrf
                                                ...
                                                <div class="row g-4">
                                                              ...
                                                              <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" data-msg="" class="form-control " id="fw-first-name" value="{{ Auth::User()->company}}" name="name" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
